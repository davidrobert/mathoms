...
export type PrevidenciaSnapshot = {
  "planos_pgbl_count": number;
  "planos_vgbl_count": number;
  "aporte_pgbl_realizado_anual": number;
  "saldo_total_31_12": number;
};

export type FinanceiroPJSnapshot = {
  "informes_count": number;
  "receita_bruta_total_anual": number;
  "retencoes_totais_anuais": number;
  "regime_declarado": string | null;
  "ano_base_coberto": number | null;
};

export type motivo_ausencia_pgbl = "sem_irpf_processado" | "modelo_simplificado" | "sem_renda_tributavel" | "regime_fiscal_incompleto" | "irpfm_pode_vincular" | "base_familiar_nao_particionada" | "sem_imposto_a_reduzir" | null;
...
export type CaixaDetalhe = {
  ...
  "data_referencia_precisao"?: string;
  "conversao"?: ConversaoMe;
};
...
export type E5AnalysisArtifact = {
  ...
  "patrimonio": {
    ...
    "caixa_me_brl"?: number;
    "caixa_detalhes"?: Array<CaixaDetalhe>;
    "composicao"?: Array<{
      "categoria"?: string;
      "valor"?: number;
      "pct"?: number;
  ...
  "previdencia_pgbl"?: {
    ...
    "capacidade_restante_anual"?: number | null;
    "pgbl_status"?: "capacidade_disponivel" | "modelo_simplificado" | "no_teto" | "sem_renda_tributavel" | null;
    "pgbl_aportado_anual"?: number | null;
    "excedente_nao_dedutivel_anual"?: number | null;
    "motivo_ausencia"?: {
      "teto": motivo_ausencia_pgbl;
      "restante": motivo_ausencia_pgbl;
      "aporte": motivo_ausencia_pgbl;
      "economia": motivo_ausencia_pgbl;
    };
  ...
  "investimentos"?: {
    ...
    "nao_classificado_itens"?: Array<{
      "locator": string;
      "pct_carteira_financeira": number;
      "autoridade": "sem_match" | "sem_haystack" | "sem_mapa";
    }>;
    "fonte"?: "irpf_bens";
    "top_ativos"?: Array<{
      "posicao": number;
  ...
  "tributario"?: {
    ...
    "cascata": {
      ...
      "motivo_nao_suportado": "perfil_incompleto" | "lucro_real" | "anexo_simples_pendente" | null;
      ...
      "pgbl_motivo_inaplicavel": "declaracao_simplificada" | "renda_tributavel_pf_zerada" | "tipo_declaracao_desconhecido" | null;
      "fator_r_pct": number | null;
      "fator_r_faixa": "anexo_iii" | "anexo_v" | null;
      "fator_r_break_even_mensal": number | null;
      "triggers": Array<CascataTrigger>;
      "receita_pj_detectada_anual": number;
      "signals": Array<string>;
      "previdencia_snapshot": PrevidenciaSnapshot | null;
      "financeiro_pj_snapshot": FinanceiroPJSnapshot | null;
    };

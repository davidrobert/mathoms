...
1. **Ler o contexto** — primeiro os docs do Contexto obrigatório (PRODUCT, PHASES, SPRINT_CURRENT/SPRINTS-active, CHANGELOG, ADRs relevantes, plano ativo se houver); depois Read/Grep no que importa: lane específica, scripts/serviços onde a feature aterrissa.

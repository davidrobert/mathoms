...
| Verificar | Como |
|---|---|
| Todo PR da lane aparece no registro da sprint | `grep "#<N>" docs/sprint/<X>/_README.md docs/sprint/<X>/_HISTORY.md` — o registro é os **dois**: o `split_sprint_history.py` é mandatório e moveu 24 PRs da A40 para o histórico (A40.l59 §Ataque §3). Lane com 2+ PRs: o `ship_pr` nomeia **um**; os outros vivem no corpo |

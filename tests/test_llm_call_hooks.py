...
class _RecordingHooks:
    ...
    def __init__(
        self, budget_error: Exception | None = None, record_error: Exception | None = None
    ):
    ...
    def record_call(self, result, *, stage, prompt_version) -> None:
        ...
        self.recorded.append({"result": result, "stage": stage, "prompt_version": prompt_version})
...
def test_budget_exceeded_blocks_before_provider_call() -> None:
    hooks = _RecordingHooks(budget_error=LLMBudgetExceededError("ws-1", spent_usd=6, budget_usd=5))

...
**E2 / PDFs:** o alinhamento filename → parser está em `tests/test_e2_synthetic_pdf_parsers.py`; o gerador central é `tests/fixtures/pdf_generator.py` (layouts dedicados para **todo** o `scripts/e2/registry.py` — **C6**, **Bradesco**, **BTG**, **Rico**, **Wise**, **PicPay**, **Bank of America**, **Santander**, **Itaú**, **Caixa**, **Quinto Andar**). **Fase 2 opcional:** PDFs reais anonimizados — ver [PIPELINE_ARTIFACTS.md](../../../docs/reference/PIPELINE_ARTIFACTS.md) § *E2 — sintético e real anonimizado*.

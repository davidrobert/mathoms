...
class TestResult:
    ...
    def test_to_legacy_dict_has_required_fields(self):
        ...
        d = r.to_legacy_dict()
        assert {"pct_presente", "pct_futuro", "classificacao", "presente", "futuro"}.issubset(d.keys())
...
class TestCustomClassificacao:
    def test_custom_faixas_selecionam_corretamente(self):
        ...
        # pct_futuro = 60 → Mid
        r = EquilibrioCerbasiAnalyzer(cfg).analyze(_fluxo({
            "moradia": 40_000, "investimentos": 60_000,
        }))

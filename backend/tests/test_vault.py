...
async def test_vault_delete_password(auth_client: AsyncClient):
    ...
    del_resp = await auth_client.delete(
        f"/api/workspaces/{auth_client.ws_id}/vault/passwords/{pw_id}"
    )
...
async def test_vault_delete_not_found(auth_client: AsyncClient):
    resp = await auth_client.delete(
        f"/api/workspaces/{auth_client.ws_id}/vault/passwords/nonexistent-id"
    )
...
async def test_vault_unauthorized(client: AsyncClient):
    resp = await client.get("/api/workspaces/00000000-0000-0000-0000-000000000000/vault/passwords")

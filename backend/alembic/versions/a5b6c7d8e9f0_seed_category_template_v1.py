...
_EXPENSE_KEYWORDS: dict[str, list[str]] = {
    ...
    "alimentacao": [
        ...
        "BAR DA JULINHA",
        "CANTINA",
        "CANTINHO DOS MINEIROS",
        "BLMT COMERCIO DE ALIME",
        "CARR EXPRESS",
        "CASA BAUDUCCO",
        "CASA PILAO",
        "CHAPEU DE SOL",
        ...
        "OUTBACK",
        "MCDONALD'S",
        "ALCHINGER LANCHONETE",
        "MOUSTACHE BEAMS",
        "LANCHONETE REAL DA VI",
        "LANCHONETE CAMPING",
        "BOTHANICO RESTAURANTE",
        "CUBO BAR E RESTAURANTE",
        "ARKO S RESTAURANTE",
        "ARKOS RESTAURANTE",
        "RESTAURANTE PAND",
        "SPACE SETE COM DE ALIM",
        "PIZZA HUT",
        "DEL NERO E MIRANDEZ",
        "EMPORIO PAES",
        "EMPORIO PINHEIROS",
        "PADARIA SANTA MARINA",
        "PADARIA FAMA",
        "CAFE DAS COISINHAS",
        "HORTIFRUTIRUI",
        "GRAAL MARKET",
        ...
        "METRO PIZZA",
        "CARRINHO DO DUDA",
        "AMO AV MORUMBI DRIVE",
        "RAPPI*RAPPI BRASIL INT",
        "RAPPI *RAPPI RAPPI BR",
        "RAPPI BRASIL INTERMEDI",
        "DL *DLRAPPI BR",
        "DL*DLRAPPI BR",
        "DL *DLRAPPIPROBR",
        "EJM RESTAURANTE JAPONE",
        "PAYGO*LG ESPETOS",
        "POINTJABAQUARA",
        "M L MATOS CONVENIENCIA",
        "EMPORIOMATTERLTDA",
        "SAMS CLUB",
        "SAM'S CLUB",
        "FIVE GUYS",
    ...
    "transporte": [
        ...
        "MCOUTINHO MOBILITY",
        "EXXON AUTOMATED",
        "BANDEIRA PAULISTA PAR",
        "AUTOVAGAS",
        "MARANATA SERVICOS DE G",
        "CORREA CONVENIENCIA",
        "MULTA DE VEICULO",
        "MULTA VEICULO",
        "DETRAN",
        ...
        "AN ESTACIONAMENTO",
        "MMW ESTACIONAMENTOS",
        "ESTAC T*ESTACIONAMENT",
        "LTL ESTACIONAMENTO",
        "MP *ESTACIONAMENT",
        "CITY OF CLEARWATER PAR",
        "CITY OF ORLANDO PKG",
        "F.M ESTETICA AUTOMOTIV",
        "MAIS DISTR VEICULOS",
        "PROPIG *FPS BATERIAS",
        "MOTO DAKAR",
        "MULTA DE VE",
    ...
    "assinaturas": [
        ...
        "APPLE.COM/BILL",
        "APPLECOMBILL",
        "AMAZON PRIME ALUGUEL",
        "AMAZON PRIME*",
        "CLUBE LIVELO*CLUBE LIV",
        "LIVELO*CLUBE LIVELO",
        "CLUBE LIVELO",
        "LIVELO S.A.",
        "SMILES CLUB",
    ...
    "lazer_viagens": [
        ...
        "NIC*-DOH ORA VITAL",
        "MINUTE SUITES",
        "ZIG*VILLA DI PHOENIX",
        "ZIG. THE GLOBAL FUNTEC",
        "A NOIESA",
        "AEROP. ADOLFO SUAREZ",
        "ASSOC COMERCIAL PORT",
        "AUDASA VISA",
        "CATEDRAL DE SANTIAGO",
        "CHEZ LAPIN",
        "CPPB-RUA AUGUSTA",
        "FUNDACAO CULTURSINTR",
        "MANTEIGARIA SILVA",
        "ATL PANDA EXPRESS",
        "FAST POINT MC",
        "DOLLAR TREE",
        ...
        "PLAZA SUL",
        "ALIANSCE",
        "SHOPPING CENTER IBIRAP",
        "PARQUE RIBEIRA",
        "BOFT BRASIL",
        "FURY ADVENTURES",
        "UNIVERSAL STORE",
        "BISUTTI",
        "PLATAFORMA S*BISUTTI",
        "PLATAFORMA S BISUTTI",
        "ICASEI",
        "NUVEM CUTELARIAORI",
        "CLEIDIANY",
    ...
    "financeiro": [
        ...
        "D4U",
        "MORAR EUA",
        "IN *CA TRANSLATION SER",
        "TABEL",
        "CLAUDIA DANTAS TINOCO",
    ],
    "impostos": [
        "DEBITO RFB",
        "DAS SIMPLES",
...
_AUX_METADATA: dict[str, Any] = {
    "internal_transfer_patterns": [
        ...
        "bx Aut Cta Cor",
        "Reserva - Seu dinheiro guardado rende",
    ...
    try:
        ...
        return {
            ...
            for r in bind.execute(
                sa.text("SELECT key FROM category_templates WHERE template_version = :v"),
                {"v": _TEMPLATE_VERSION},
            ).fetchall()
        }
...
def downgrade() -> None:
    bind = op.get_bind()
    bind.execute(
        sa.text("DELETE FROM category_templates WHERE template_version = :v"),
        {"v": _TEMPLATE_VERSION},
    )

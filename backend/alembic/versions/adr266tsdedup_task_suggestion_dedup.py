"""adr-266 task_suggestions dedup_key + soft-supersede (Revision: adr266tsdedup, Revises: adr262memconf, Create Date: 2026-05-23). Adiciona dedup_key (sha256 normalizado), superseded_at, superseded_by_run_id + índice parcial ix_tsugg_ws_dedup_active filtrado por status IN ('pending','approved')."""

...
def _legacy_validation_text(validation: dict) -> str:
    ...
    heterogênea levanta TypeError ANTES da transição de estado (ADR-396)."""
...
def _project_issues(db, run_id: str, stage_name: str, workspace_id: str, reasons: list[dict]):
    ...
    except Exception as exc:  # noqa: BLE001 — ver ADR-396
...
# `StageReview` fica do lado do CONTROLE de propósito (ADR-396): `resume_run` só
...
# Ordem obrigatória (ADR-396): controle commita primeiro e sozinho; o analítico

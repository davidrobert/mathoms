...
def _legacy_validation_text(validation: dict) -> str:
    ...
    heterogênea levanta TypeError ANTES da transição de estado (ADR-395)."""
...
def _project_issues(db, run_id: str, stage_name: str, workspace_id: str, reasons: list[dict]):
    ...
    except Exception as exc:  # noqa: BLE001 — ver ADR-395
...
# `StageReview` fica do lado do CONTROLE de propósito (ADR-395): `resume_run` só
...
# Ordem obrigatória (ADR-395): controle commita primeiro e sozinho; o analítico

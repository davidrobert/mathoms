...
_WORKSPACE_TABLES: tuple[tuple[str, type], ...] = (
    ...
    ("family_member_protection_profiles", FamilyMemberProtectionProfile),
    ("economic_dependencies", EconomicDependency),
    ("protection_income_declarations", ProtectionIncomeDeclaration),
    ("family_member_tax_profiles", FamilyMemberTaxProfile),
    ("risks", Risk),

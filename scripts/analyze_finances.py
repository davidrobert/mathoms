...
def _resolve_members(baseline: Dict[str, Any]) -> tuple:
    ...
    if isinstance(members, list):
        ...
        # Prefer consolidated path if imoveis_consolidados was generated by consolidate_baseline
        ...
        if baseline.get("declarations"):
            print(
                "  [WARN] Baseline em formato E1.5 declarations sem chaves consolidadas — usando fallback. Execute: python scripts/consolidate_baseline.py"
            )

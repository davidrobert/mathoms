...
def _compare_section(
    ...
    delta_pct, signal = _compute_delta(before, after, config.threshold_for(section_id))
...
def _compute_delta(
    ...
    """Computa `delta_pct` em pontos percentuais e signal por threshold."""
    if before == 0:
    ...
    return delta_pct, _classify_signal(delta_pct, threshold_pct)
...
def _classify_signal(delta_pct: Decimal, threshold_pct: Decimal) -> DeltaSignal:
    """Classifica signal por magnitude vs threshold."""

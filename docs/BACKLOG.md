...
| **Report Premium UI v2** (guarda-chuva — 20 sub-lanes em 5 ondas) | `report-v2-*` (sub-slug por lane) | Meta-prompt + paralelização: [track_report_v2.md](agent_prompts/track_report_v2.md). **Onda A 2026-04-26:** ✅ v2.1 (`cbb389a`) · ✅ v2.3 (`4aebe50`) · ✅ v2.2 parcial (`0558ea3` — 28/48 baselines + 2 fixes CI: `a856e0b`, `02216f8`). Resíduo: **v2.2b** (Tático+USA baselines, P1 ≤2h). **Onda E (charts UX) 2026-04-26 — 7/8 entregues em main:** ✅ v2.E.1 (`da841c2`) · ✅ v2.E.2 (`8ee4bd6`) · ✅ v2.E.3 (`5b8d54a`) · ✅ v2.E.4 (`0e07499`) · ✅ v2.E.5 (`6d0ab67`) · ✅ v2.E.6 (`6c2efc4`+`f8cb30f`+`6b09407`+`32089ce` + cleanup `d9fa765`+`358d5ea`) · ✅ v2.E.7 (`55f00fa`+`22ca7d0`+`334f5f7`+`529cd70`; absorve v2.5). **Falta v2.E.8** (re-baseline visual + cleanup imports Recharts + ADR-13X) — destravada para pickup imediato. Prompt dedicado: [track_report_v2_charts_ux.md](agent_prompts/track_report_v2_charts_ux.md). **Coordenação de hotspot validada:** `useIsPrint.ts` (E.3 venceu) · `pickColorByIndex` em `_shared.ts` (E.5 venceu) · v2.D.1+v2.8 destravados ([prompt dedicado fundido](agent_prompts/track_report_v2_changelog_engine.md)) · Onda B: v2.4 ([prompt dedicado](agent_prompts/track_report_v2_t2_aportes.md)) · v2.6 · Onda C: v2.7 · v2.9 · v2.10. Tabela detalhada + ondas + pickup protocol em [§Report Premium UI v2](#report-premium-ui--paridade-com-exemplo_de_relatoriohtml). | v1 ✅ (10 fases + 3 lanes residuais) | P0/P1/P2 (mistura por lane) | 🚧 **Onda A 3/3 (com débito v2.2b) · E 7/8 entregues, E.8 destravada** · Ondas B/C/D abertas para pickup paralelo |
...
| **v2.E.8** re-baseline visual + cleanup imports Recharts + ADR-13X | fechamento da onda | `report-v2-charts-rebaseline` | [track_report_v2_charts_ux.md §3 v2.E.8](agent_prompts/track_report_v2_charts_ux.md) | v2.E.3-7 ✅ TODAS | E | S (≤4h) | P0 | ☐ **destravada — pickup imediato** (E.3-E.7 todas em main 2026-04-26) |
...
- **Onda E — 7/8 entregues 2026-04-26 (2 levas paralelas: 3 agentes + 4 agentes), 1/8 sequencial restante:**
  ...
  - ☐ **Pickup imediato — único agente sequencial:** v2.E.8 (`report-v2-charts-rebaseline`, P0, ≤4h) — re-trigger workflow `frontend-visual` opt-in (`gh workflow run CI -f run_visual=true -f update_visual_baselines=true`), commitar baselines novos, cleanup imports Recharts em `_registry.ts`/`_shared.ts`, gravar ADR-13X "Finalização migração Recharts→Chart.js em /reports/**".

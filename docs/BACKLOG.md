...
| **Report Premium UI v2** (guarda-chuva — 20 sub-lanes em 5 ondas) | `report-v2-*` (sub-slug por lane) | Meta-prompt + paralelização: [track_report_v2.md](agent_prompts/track_report_v2.md). **Onda A 2026-04-26:** ✅ v2.1 (`cbb389a`) · ✅ v2.3 (`4aebe50`) · ✅ v2.2 parcial (`0558ea3` — 28/48 baselines + 2 fixes CI: `a856e0b`, `02216f8`). Resíduo: **v2.2b** (Tático+USA baselines, P1 ≤2h). **Onda E (charts UX) aberta 2026-04-26** — 8 sub-lanes finalizam migração Recharts→Chart.js + introduzem `PeriodToggle` + plugam `ScoreCard` premium + slide window 12m em "Receita vs Despesa Mês a Mês". Absorve v2.5 (score DTO) em v2.E.7. Prompt dedicado: [track_report_v2_charts_ux.md](agent_prompts/track_report_v2_charts_ux.md). **Pickup hoje:** v2.E.1 + v2.E.2 (enablers, paralelos, ≤4h cada) · v2.E.7 (independente, ½-1d) · v2.D.1+v2.8 destravados ([prompt dedicado fundido](agent_prompts/track_report_v2_changelog_engine.md)) · Onda B: v2.4 ([prompt dedicado](agent_prompts/track_report_v2_t2_aportes.md)) · v2.6 · Onda C: v2.7 · v2.9 · v2.10. Tabela detalhada + ondas + pickup protocol em [§Report Premium UI v2](#report-premium-ui--paridade-com-exemplo_de_relatoriohtml). | v1 ✅ (10 fases + 3 lanes residuais) | P0/P1/P2 (mistura por lane) | 🚧 **Ondas A 3/3 (com débito v2.2b) · E aberta 8 sub-lanes** · Ondas B/C/D abertas para pickup paralelo |
...
| **v2.5** score top-level no DTO | §3.4 auditoria | ~~`report-v2-score-dto`~~ | — | v1 ✅ | B → E | S (≤4h) | P2 | 🔀 **absorvida em v2.E.7** (`report-v2-score-card-plug`) 2026-04-26 — escopo do DTO + casts `as ScoreData` foram fundidos no plug do `ScoreCard` premium (Parte B do prompt). Não pegar isolada; rastrear via v2.E.7 |
...
| **v2.E.1** PeriodToggle + hook `usePeriodWindow` | nova lacuna (3M/6M/12M/Ano ausente no React) | `report-v2-period-toggle` | [track_report_v2_charts_ux.md §3 v2.E.1](agent_prompts/track_report_v2_charts_ux.md) | v1 ✅ | E | S (≤4h) | P0 | ☐ aberta — **enabler de v2.E.3/E.4/E.5** |
| **v2.E.2** TS types `receita_datasets`/`despesa_datasets` | gap descoberto na análise charts UX | `report-v2-fluxo-types` | [track_report_v2_charts_ux.md §3 v2.E.2](agent_prompts/track_report_v2_charts_ux.md) | v1 ✅ | E | S (≤2h) | P0 | ☐ aberta — **enabler de v2.E.4/E.5/E.6** |
| **v2.E.3** FluxoMensal Recharts→Chart.js + PeriodToggle | finalização migração ADR-117 Fase 7 | `report-v2-fluxo-mensal-chartjs` | [track_report_v2_charts_ux.md §3 v2.E.3](agent_prompts/track_report_v2_charts_ux.md) | v2.E.1 ✅ | E | R (1d) | P1 | ☐ bloqueada por v2.E.1 |
| **v2.E.4** ReceitaBar Recharts→Chart.js + PeriodToggle (séries mensais) | finalização migração ADR-117 Fase 7 | `report-v2-receita-bar-chartjs` | [track_report_v2_charts_ux.md §3 v2.E.4](agent_prompts/track_report_v2_charts_ux.md) | v2.E.1 ✅ + v2.E.2 ✅ | E | R (1d) | P1 | ☐ bloqueada por v2.E.1+E.2 |
| **v2.E.5** DespesasDoughnut Recharts→Chart.js + datalabels + PeriodToggle | finalização migração ADR-117 Fase 7 | `report-v2-despesas-doughnut-chartjs` | [track_report_v2_charts_ux.md §3 v2.E.5](agent_prompts/track_report_v2_charts_ux.md) | v2.E.1 ✅ + v2.E.2 ✅ | E | R (1d) | P1 | ☐ bloqueada por v2.E.1+E.2 |
| **v2.E.6** ReceitaDespesaMensal Recharts→Chart.js + slide window 12m + tooltip stack + legenda agrupada | paridade `EXEMPLO_DE_RELATORIO.html:1794-1806` + script :7756-7939 | `report-v2-receita-despesa-chartjs` | [track_report_v2_charts_ux.md §3 v2.E.6](agent_prompts/track_report_v2_charts_ux.md) | v2.E.2 ✅ | E | R/O (1-2d) | P1 | ☐ bloqueada por v2.E.2 |
| **v2.E.7** Plugar ScoreCard premium em S1 + `score.context`/`conclusion` (absorve v2.5) | paridade gauge profissional + chart-context/conclusion no Score | `report-v2-score-card-plug` | [track_report_v2_charts_ux.md §3 v2.E.7](agent_prompts/track_report_v2_charts_ux.md) | v1 ✅ | E | R (½-1d) | P1 | ☐ aberta — independente das demais Eyx; absorve v2.5 |
...
- **Onda E aberta — pickup imediato (charts UX):**
  - **Disparar agora em paralelo:** v2.E.1 (`report-v2-period-toggle`, P0, ≤4h) + v2.E.2 (`report-v2-fluxo-types`, P0, ≤2h) + v2.E.7 (`report-v2-score-card-plug`, P1, ½-1d, independente).
  - **Após E.1+E.2 mergeados:** v2.E.3, v2.E.4, v2.E.5, v2.E.6 (até 4 agentes paralelos, atenção ao hotspot `_shared.ts`/`_registry.ts` — protocolo CLAUDE.md §Hotspots).
  - **Último, sequencial:** v2.E.8 (re-baseline visual + cleanup + ADR-13X) só após E.3-E.7 ✅ em main.

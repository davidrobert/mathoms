...
**Status global (2026-04-27):** 🚧 em andamento — **A7.0 ✅** + **A7.1 ✅** (Onda 2 começou: cutover `materialize_config` mergeado em `main`; configs A7.1 fluem via `WorkspaceContext.config_overrides` populado por `build_config_overrides_from_db` no worker boundary). Onda 2 ainda livre para A7.2a, A7.2b + A7.4 (3 lanes paralelas). A7.3 destravada por A7.1.
...
| **A7.2a** Decision aggregate (event-sourced) + migrator + UI Plano de Ação | `a7-2a-decision-aggregate` | [track_a7_2a_decision_aggregate.md](agent_prompts/track_a7_2a_decision_aggregate.md) | A7.0 ✅ | 2 | A7.1, A7.2b, A7.4 | 🚧 em andamento — agente A7.2a |
...
| **A7.4** Metodologia → `docs/methodology/` (4 `.md` movidos) | `a7-4-methodology-docs` | [track_a7_4_methodology_docs.md](agent_prompts/track_a7_4_methodology_docs.md) | — (independente) | 2 (livre) | qualquer lane | 🚧 em andamento — agente A7.4 |
...
- **Onda C aberta:** ~~v2.7~~ (✅ 2026-04-27) · v2.9 · v2.10 (paraleláveis com B/D).

...
**Status global (2026-04-27):** 🚧 em andamento — **A7.0 ✅** + **A7.1 ✅** + **A7.2a ✅** + **A7.2b ✅** + **A7.4 ✅** + **A7.6 ✅** (6 lanes mergeadas no mesmo dia). A7.6 dissolveu `docs/methodology/` (rules-as-code, ADRs 143/145/146/147), reforçando CLAUDE.md §Regras críticas e fechando o débito introduzido por A7.4. A7.3 destravada por A7.1 (Onda 3 livre — em curso).

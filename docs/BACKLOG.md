...
| **A6g.4** frontend sweep | `a6g4-frontend-style` | [track_a6g4_frontend_style_sweep.md](agent_prompts/track_a6g4_frontend_style_sweep.md) | A6g.1 ✅ | 1 | 🚧 parcial — rodada 1 mergeada em main (commit `5a7b577`) + rodada 2 (A6g.4b) no branch `/20260421-1313` decompõe 4 das 6 páginas `>500 l` (`pipeline/documents/transactions/dashboard`) + extrai 3 hooks de `TransactionsContent`. Total offenders 53 → 27 (49%). **A6g.4c** pendente: `plano/page.tsx` (630) e `plano/alocacao/wizard/page.tsx` (533). |

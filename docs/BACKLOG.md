...
| **A6g.4** frontend sweep | `a6g4-frontend-style` | [track_a6g4_frontend_style_sweep.md](agent_prompts/track_a6g4_frontend_style_sweep.md) | A6g.1 ✅ | 1 | 🚧 ocupada — rodada 1 do branch `/20260421-1137` **mergeada em main** (commit `5a7b577`); worktree ativo `agent/a6g4-frontend-style/20260421-1313` continua a rodada 2 (confirmar com `git worktree list`) |
...
| **A6e.3b** use cases remanescentes (ConfigBlob+Document+Task) | `a6e3b-use-cases-rest` | Aplicar padrão de A6e.3 aos 3 agregados restantes. Prompt ainda não escrito — se copiar [track_a6e3_use_cases.md](agent_prompts/track_a6e3_use_cases.md) ajustando o escopo. | A6f.1 ✅ destravou | 2 | ☐ aberta |
...
| **A6g.7** Go prep | `a6g7-go-prep` | `golangci-lint.yml` | A6f.1 ✅ destravou | 3 | ☐ aberta |

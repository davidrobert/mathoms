...
| **v2.6** cards/ legacy: deprecate ou migrar | §3.6 auditoria | `report-v2-cards-cleanup` | inline em [track_report_v2.md §3](agent_prompts/track_report_v2.md) | v1 ✅ | B | R (1d) | P2 | 🚧 `agent/report-v2-cards-cleanup/20260427-0951` |

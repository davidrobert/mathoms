...
| [`orchestrator_a24_f2f3.md`](orchestrator_a24_f2f3.md) | A24 Data Lineage · F2 (de-leak da extração) + F3 (walking skeleton) + F4 (evidencia_path ∥) — fase de risco; pré-revisado (F2-B/F2-DB) | ativo (2026-06-09) |

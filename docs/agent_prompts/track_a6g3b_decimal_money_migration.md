...
> **Fonte de verdade:** [ADR-090](../DECISIONS.md#adr-090) · [CLAUDE.md §Dinheiro nunca é float](../../CLAUDE.md#dinheiro-nunca-é-float-adr-090) · [ADR-114 baseline](../DECISIONS.md#adr-114) · audit `dev/code_style_baseline.json` (categoria `P5_float_money`)
...
- [ADR-090](../DECISIONS.md#adr-090) — Dinheiro nunca é `float` (regra original)
- [ADR-114](../DECISIONS.md#adr-114) — Enforcement automatizado de code style (A6g.6)

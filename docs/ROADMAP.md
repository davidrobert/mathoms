...
**Backend:** 3 migrations (analysis_json_path, invitations, token_version), 5 endpoints novos (/data, /download.html, /download.pdf, invitations CRUD), PDF server-side Playwright. _Endpoints `/html` e `/download.html` removidos em 2026-04 via [ADR-129](DECISIONS.md#adr-129--descontinuação-completa-do-renderer-html-server-side)._

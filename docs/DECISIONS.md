...
**Status:** Decidido (Fase 0) • **Data:** 2026-04-23 • **Revisado:**
2026-04-24 (§Implementação abaixo) • **Supersedes** parte operacional
de ADR-076 (seção "e6_render.py é exportador standalone").

...
Este arquivo é o input manual para o card "Programa de Milhas — Economia" na Seção 2 do relatório.
...
- `custo_medio_ponto_brl`: custo médio de aquisição por ponto, em R$ (se conhecido)
- `valor_estimado_brl`: valor estimado do saldo em R$ (saldo × valor de mercado por ponto)

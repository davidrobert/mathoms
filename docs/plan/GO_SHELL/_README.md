...
### F0 — Pré-requisitos hard (ordem obrigatória da [[ADR-150]] §4) — 🚧 em curso
...
| A3.cli — entry-point CLI `run-stage` no orchestrator (+ injeção `DBArtifactStore`) | ⬜ ready | [tracks/a3cli-orchestrator-cli.md](tracks/a3cli-orchestrator-cli.md) Fase 1 |
...
| A3.cli.benchmark — gate empírico de cold start (decide Caminho 2) | ⏸ bloqueado até A3.cli mergeado | [tracks/a3cli-benchmark.md](tracks/a3cli-benchmark.md) |

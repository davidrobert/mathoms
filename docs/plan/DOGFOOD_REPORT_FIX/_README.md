...
| 3 | **P1** | A · emenda [[ADR-191]] | Registrar `ganho_capital` como causa-raiz provável dos 14,08% (realização one-time no numerador do yield) + follow-up p/ excluí-lo. Documentar override 5% (yield-meta BR) vs 4% (Trinity-depleção). |

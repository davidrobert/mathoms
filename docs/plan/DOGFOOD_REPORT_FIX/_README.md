...
>
> **Balanço da onda R2 (2026-07-15):** dos 12 itens curados — **10 shipados/ratificados** (PD-02, CTO-02, CTO-06 [R2.1]; FP-03, CTO-04, PD-01, CTO-05 [R2.2]; DE-02, FP-02-ratificação, DE-01-Fase1 [R2.3]); **FP-04** deferido (acoplado à lane coordenada `score_version 2.0`); **DE-03** design travado (lane write-path, P3). Deferidos com gate explícito: lane coordenada 2.0 (plateau+FIN-05+FIN-01+FP-04+218-card), DE-01 Fase 2 (soak/owner), DE-03 (write-path).

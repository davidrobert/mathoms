...
| **S7 / IRPF — PGBL**             | Nota da S7 quebra naturalmente; `IrpfPgblCapacidadeCard` mantém leitura em uma coluna.       | Teto e capacidade têm dono único no Card B; nenhuma grade fiscal duplicada em 375px.                                |

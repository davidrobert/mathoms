...
| **3 — Backbone (skeleton)** | **A24** 🚧 (l5 ✅ #588 — G3/KR2 1/6; l6 in_progress) | `dl-f3-skeleton-patrimonio` (walking skeleton) · `dl-f3-skeleton-resto` (reserva/despesa/total investido) | P0/P1 | **G3:** ver abaixo (byte-identidade sobre **view-model snapshot**, não payload E2 — F2-B8) |

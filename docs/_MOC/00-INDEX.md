...
| "Que defeitos as revisões do relatório entregue acharam?" | [REPORT-REVIEWS-active](REPORT-REVIEWS-active.md) (editorial) |
...
| "Quais notas existem por tipo/status?" | `_generated/INDEX.md` (auto, uma linha por nota) |
...
│   ├── REPORT-REVIEWS-active.md ← editorial: defeitos das revisões do relatório entregue
...
- Inventário atual por tipo/status: [`_generated/INDEX.md`](_generated/INDEX.md).

...
| ADR-259 | adr | Decidido |  | Boundary LLM unificado — Decimal monetário + PII (cpf_present + Fernet + UX decrypt) | `adr/259-boundary-llm-unified.md` |
...
| ADR-328 | adr | Decidido |  | score_version 2.0 — plateau da cobertura de reserva no alvo do perfil (não premiar over-provisioning) | `adr/328-score-version-2-plateau-cobertura-reserva.md` |
...
| ADR-332 | adr | Decidido |  | Sanitização de PII no contexto do parecer + gate PII-scan | `adr/332-sanitizacao-pii-contexto-parecer-gate-scan.md` |
...
| ADR-337 | adr | Decidido |  | Rótulo de exibição sem PII para ativos — sanitização na fonte E5 (React + prompt) | `adr/337-rotulo-exibicao-sem-pii-tabela-ativos.md` |
...
| ADR-389 | adr | Proposto |  | As tabelas mensal e anual do IRPF são duas fontes importadas, não duas escalas de uma | `adr/389-tabela-mensal-e-anual-do-irpf-sao-duas-fontes-importadas.md` |
| ADR-390 | adr | Decidido |  | Conversão ME→BRL carrega taxa, data, fonte e status; ausência é explícita | `adr/390-conversao-me-brl-carrega-proveniencia.md` |
...
| ADR-401 | adr | Decidido |  | Item de dívida declara a fonte de cada campo (fontes por chave, enum próprio) | `adr/401-item-de-divida-declara-a-fonte-de-cada-campo.md` |
...
| ADR-412 | adr | Decidido |  | Base canônica única para carteira financeira, `Papel` ternário e produtor único do eixo de posições atuais | `adr/412-base-canonica-unica-papel-ternario-e-produtor-do-eixo-de-posicoes.md` |
...
| A12.alocacao-v2 | lane | shipped | A12 | Alocação-alvo schema v1→v2 (7 classes AUVP, desvio backend-driven) | `sprint/A12/lanes/A12-alocacao-v2-migration.md` |
...
| A12.decision-code-autogen | lane | shipped | A12 | Decision.code server-generated (UX cleanup + race fix) | `sprint/A12/lanes/A12-decision-code-autogen-server-gen.md` |
| A12.irpf-prefill-bank-accounts | lane | shipped | A12 | Pre-fill UI a partir de IRPF — V1 contas bancárias (deferred → A13) | `sprint/A12/lanes/A12-irpf-prefill-bank-accounts-deferred-a13.md` |
| A12.sunset-disk-artifact | lane | shipped | A12 | Sunset DiskArtifactStore + flag MATHOMS_USE_DB_ARTIFACTS + CLI standalone | `sprint/A12/lanes/A12-sunset-disk-artifact-cleanup.md` |
...
| A17.l3 | lane | shipped | A17 | Informes anuais — L3 financeiro PF (6 bancos + XP Investimentos + Wise multi-moeda) | `sprint/A17/lanes/A17-l3-financeiro-pf.md` |
...
| A28.l5 | lane | shipped | A28 | nao_identificado 23% → <5%: regras via Learning Loop + gate de reclassificação do owner | `sprint/A28/lanes/A28-l5-nao-identificado-learning-loop.md` |
| A28.l6 | lane | shipped | A28 | proteção patrimonial ativada: apólices extraídas fluem para compute_protecao + pontos_urgentes condicional | `sprint/A28/lanes/A28-l6-protecao-apolices-flow.md` |
...
| A32.l6 | lane | shipped | A32 | review UX: identidade legível + selo de natureza + copy sem contradição + agrupamento por documento | `sprint/A32/lanes/A32-l6-review-ux-identidade-natureza.md` |
| A32.l7 | lane | shipped | A32 | gate: re-run dogfood instrumentado + classificação genuíno-vs-falso + triagem do owner | `sprint/A32/lanes/A32-l7-gate-rerun-dogfood.md` |
...
| A33.l2 | lane | shipped | A33 | Fechar A17.l3: informes financeiro PF P3-P5 (consolidate_baseline + PTAX 31/12 + UI S4 + validações Wise) | `sprint/A33/lanes/A33-l2-a17l3-financeiro-pf-fechamento.md` |
...
| A34.l10 | lane | shipped | A34 | Purgar CPFs + neutralizar endereço residencial | `sprint/A34/lanes/A34-l10-purge-cpf-addresses.md` |
| A34.l11 | lane | shipped | A34 | Neutralizar seed de produção + report_spec + paths | `sprint/A34/lanes/A34-l11-sanitize-seed-migration-paths.md` |
...
| A34.l13 | lane | shipped | A34 | permissions read-all default + elevação por-job | `sprint/A34/lanes/A34-l13-actions-permissions-readonly.md` |
| A34.l14 | lane | shipped | A34 | SHA-pin das 4 actions de terceiros por tag flutuante | `sprint/A34/lanes/A34-l14-sha-pin-third-party-actions.md` |
...
| A34.l24 | lane | shipped | A34 | Varredura da PII residual sub-contada pelo audit (código/testes/fixtures/schema) | `sprint/A34/lanes/A34-l24-residual-pii-surface.md` |
...
| A34.l3 | lane | shipped | A34 | Confirmação operacional: rotação Fernet executada na instância de dogfood | `sprint/A34/lanes/A34-l3-verify-fernet-rotation.md` |
...
| A34.l6 | lane | shipped | A34 | Bloquear _archive/ em forbidden-paths + gitleaks bloqueante | `sprint/A34/lanes/A34-l6-block-archive-gitleaks.md` |
| A34.l7 | lane | shipped | A34 | Deletar _archive/ do HEAD (checar referências vivas) | `sprint/A34/lanes/A34-l7-delete-archive-dir.md` |
...
| A37.l1 | lane | shipped | A37 | Parecer enxerga o relatório inteiro: contrato de exec context (dupla truncação) + redação de identificadores | `sprint/A37/lanes/A37-l1-parecer-exec-context.md` |
| A37.l10 | lane | shipped | A37 | Apêndices: stress card com coluna base vazia + tabela de premissas 10× indisponível | `sprint/A37/lanes/A37-l10-apendices-ux.md` |
| A37.l11 | lane | shipped | A37 | Seguradora sem canonicalização: mesma cia com dois codes, count inflado e render cru | `sprint/A37/lanes/A37-l11-seguradora-canonicalizacao.md` |
| A37.l12 | lane | shipped | A37 | Resiliência de execução: heartbeat in-stage (watchdog 15min) + idempotência de stage LLM em redelivery | `sprint/A37/lanes/A37-l12-resiliencia-execucao.md` |
| A37.l13 | lane | shipped | A37 | pipeline_artifacts.schema_version e byte_size NULL em 100% das rows — popular ou dropar | `sprint/A37/lanes/A37-l13-artifacts-colunas-mortas.md` |
| A37.l14 | lane | shipped | A37 | Batch cosmético de copy/labels + decisão de agrupamento do aporte no doughnut | `sprint/A37/lanes/A37-l14-batch-cosmetico-copy.md` |
| A37.l15 | lane | in_progress | A37 | Débitos com gate: fonte de dados de milhas (decisão owner) + remoção do alias deprecated de caixa | `sprint/A37/lanes/A37-l15-debitos-owner-gated.md` |
...
| A38.l1 | lane | shipped | A38 | Harness local de certificação de parse (classify→route→parse, métricas mascaradas) | `sprint/A38/lanes/A38-l1-certify-parse-harness.md` |
| A38.l10 | lane | planned | A38 | TypeRules genéricas de fatura nunca cruzam linha (gaps `.{0,N}` sem re.DOTALL) | `sprint/A38/lanes/A38-l10-typerule-fatura-dotall.md` |
| A38.l11 | lane | planned | A38 | Fuzzy-dupe cruza-flagga extratos de moedas distintas do mesmo período (Wise USD × BRL) | `sprint/A38/lanes/A38-l11-fuzzy-dupe-moeda.md` |
| A38.l12 | lane | shipped | A38 | CDB em PDF (extrato mensal Itaú + detalhes Santander): 100% E2-llm sem parser determinístico | `sprint/A38/lanes/A38-l12-cdb-pdf-deterministico.md` |
...
| A38.l14 | lane | shipped | A38 | Buraco no gate anti-silêncio: nota parcial 'sem movimentação' silencia extrato com conteúdo | `sprint/A38/lanes/A38-l14-c6-global-gate-hole.md` |
| A38.l15 | lane | shipped | A38 | parse_c6bank não extrai o layout C6 Global (USD/EUR internacional): 0 tx com 56–199 linhas | `sprint/A38/lanes/A38-l15-c6-global-parser.md` |
| A38.l2 | lane | shipped | A38 | parse_itau perde ~50% das transações do layout 2026 do extrato PDF | `sprint/A38/lanes/A38-l2-parse-itau-layout-2026.md` |
| A38.l3 | lane | shipped | A38 | Gate anti-silêncio no E2: 0 tx ou conservação quebrada nunca vira artefato 'ok' (ADR Proposto) | `sprint/A38/lanes/A38-l3-gate-anti-silencio-e2.md` |
| A38.l4 | lane | shipped | A38 | Colisão de instituição: pattern caixa `0800 726` casa SAC Santander com conf 1.0 | `sprint/A38/lanes/A38-l4-colisao-instituicao-0800726.md` |
| A38.l5 | lane | shipped | A38 | TypeRule cdbdetalhes rouba extrato de conta com `\bCDB\b` na descrição de transação | `sprint/A38/lanes/A38-l5-typerule-cdbdetalhes-required-forte.md` |
| A38.l6 | lane | shipped | A38 | Wise: moeda decidida por filename (USD vira BRL sem LLM) + período range por extenso | `sprint/A38/lanes/A38-l6-wise-moeda-conteudo.md` |
...
| A40.l2 | lane | shipped | A40 | Identidade de lançamento cross-documento: tipo_conta com vocabulário divergente + titular vazio | `sprint/A40/lanes/A40-l2-identidade-lancamento-cross-doc.md` |
...
| A40.l22 | lane | shipped | A40 | Superfície de degradação: o relatório declara o que foi retido, inclusive no PDF | `sprint/A40/lanes/A40-l22-superficie-de-degradacao.md` |
...
| A40.l64 | lane | shipped | A40 | Redutor da Lei 15.270/2025 e IRPFM: a economia diferencial de PGBL está errada para AC2026 em diante | `sprint/A40/lanes/A40-l64-redutor-lei-15270-e-irpfm.md` |
| A40.l65 | lane | shipped | A40 | A base do PGBL perdeu a âncora de declarante: lê o IRPF mais recente, e o teto de 12% é por CPF | `sprint/A40/lanes/A40-l65-base-pgbl-sem-ancora-de-declarante.md` |
...
| A40.l80 | lane | shipped | A40 | Denominador amputado: metade da carteira não tem dono, o investível a exclui e o bruto a inclui — cinco superfícies medem 'de quanto se sabe o dono' | `sprint/A40/lanes/A40-l80-denominador-amputado.md` |
...
| A40.l89 | lane | shipped | A40 | Wiring do catálogo de alvo: o produtor suprime o limiar por falta de procedência e o parecer o republica | `sprint/A40/lanes/A40-l89-wiring-do-catalogo-de-alvo.md` |
...
| A42.l19 | lane | shipped | A42 | O guard de escrita do E4 resolve por stage e tem ramo placeholder: o balde do patrimônio reprova hoje e é gravado assim mesmo | `sprint/A42/lanes/A42-l19-guard-de-escrita-e4-inerte-no-patrimonio.md` |
...
| A42.l25 | lane | in_progress | A42 | A mesma linha do razão publica o delta com dois sinais opostos, e o sinal observado é o único que nenhuma perda de pipeline produz | `sprint/A42/lanes/A42-l25-delta-com-dois-sinais-e-mecanismo-de-instrumento.md` |
...
| PLAN-ledger-integrity | plan | in_progress |  | Ledger Integrity — conservação do razão (E3/E4) + roteamento dos 5 gaps da certificação | `plan/LEDGER_INTEGRITY/_README.md` |
...
| TRACK-adr259-rule4-cpf-view | track | consumed |  | ADR-259 rule 4 — UX decrypt de CPF em /reports/[id]: mascarado por default, 'ver completo' auditado | `plan/LLM_PROMPTS_HARDENING/tracks/adr259-rule4-cpf-view.md` |
...
| TRACK-f1-go-service | track | consumed |  | Track F1 — serviço Go pipeline-service-go (Caminho 1): 4 fases, 4 PRs | `plan/GO_SHELL/tracks/f1-go-service.md` |
| TRACK-f2-cutover | track | ready |  | Track F2 — cutover do pipeline-service-go (Caminho 1): gate técnico + gate humano + flip em prod | `plan/GO_SHELL/tracks/f2-cutover.md` |

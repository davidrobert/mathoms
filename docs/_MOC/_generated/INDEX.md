...
| ADR-412 | adr | Decidido |  | Rendimento bruto e base de cálculo são variáveis distintas, e o PGBL usa a declarada | `adr/412-rendimento-bruto-e-base-de-calculo-sao-variaveis-distintas.md` |

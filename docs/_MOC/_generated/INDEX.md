...
| ADR-248 | adr | Proposto |  | Dedup de transações cross-document no pipeline E3→E4 (chave determinística + needs_review) | `adr/248-dedup-transacoes-cross-document.md` |

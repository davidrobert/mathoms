...
| ADR-412 | adr | Decidido |  | Derivado versionado é derivado de contrato, e derivado versionado não carrega valor agregado | `adr/412-derivado-versionado-e-derivado-de-contrato.md` |

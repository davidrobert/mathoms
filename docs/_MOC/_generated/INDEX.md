...
| ADR-393 | adr | Proposto |  | Contrato de balanço de stage fan-out: queued ≡ processed + errors + skipped(motivo) | `adr/393-contrato-de-balanco-de-stage-fan-out.md` |
...
| A40.l67 | lane | open | A40 | Guarda de publicação no E5: nenhum balde de patrimônio publica negativo, e o schema deixa de aceitá-lo | `sprint/A40/lanes/A40-l67-guarda-de-publicacao-e5.md` |

...
| ADR-376 | adr | Proposto |  | Expiração por parecer-fonte + horizonte persistido — sugestão do parecer tem validade igual à da fotografia que a originou | `adr/376-expiracao-por-parecer-fonte-e-horizonte-persistido.md` |

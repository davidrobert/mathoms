...
- [[A40.l114]] — O ano de referência afirma um 31/12 que ainda não fechou, e o eixo zera imóveis, veículos e a dívida do titular · priority P0 · área pipeline/financial-planning · branch `a40-l114-ano-de-referencia-sem-documento-atras`
- [[A40.l115]] — O sanitizer de PII mede o contexto de ENTRADA e nunca o output: o relatório publica CPF parcialmente mascarado e conta bancária completa · priority P1 · área backend/frontend · branch `a40-l115-sanitizer-mede-a-entrada-e-publica-a-saida`

...
- [[A40.l100]] — O cartão rotulado NECESSÁRIO publica a renda-alvo, não o aporte que o motor calcula · priority P0 · área frontend/financial-planning · branch `a40-l100-cartao-necessario-publica-renda-alvo`
- [[A40.l101]] — O conserto da folga deixou `equivalente_meses_poupanca` auto-referente · priority P1 · área pipeline/financial-planning · branch `a40-l101-equivalente-meses-auto-referente`

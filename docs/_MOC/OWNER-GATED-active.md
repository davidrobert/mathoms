...
| Flip do cutover Go (F2) | Autorizar flip global `MATHOMS_PIPELINE_SERVICE_URL` em prod, após gate humano | gate técnico em curso; asserção de 0-LLM do Tier-1 corrigida pela [[A40.l24]] (credencial apagada dos dois braços, com prova de mutação) | Início do soak ≥2 semanas → F3 decommission | — | [[PLAN-go-shell]] |

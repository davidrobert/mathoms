...
| Redutor da Lei 15.270/2025 + IRPFM lidos no ato | Ler a Lei 15.270/2025 e carimbar (a) o **piso da banda anual do redutor** — a tabela da lane não fecha consigo mesma: a fórmula dá R$ 2.695,23 em R$ 60.000 e o teto declarado é R$ 2.694,15, R$ 1,08 na borda em que o contrato precisa ser contínuo (a banda mensal fecha a R$ 0,005) — e (b) a composição da base e dos abatimentos do **IRPFM** | ✅ o seam existe: `pgbl_economia_ir.economia_diferencial` (PR2, entregue 2026-08-24) é onde o redutor compõe; o diferencial `IR(base) − IR(base − aporte)` já roda | PR3 + PR4 da lane ⇒ AC2026 sai de `regime_completo: false` e o card volta a publicar economia | ~1h | [[A40.l64]] |

...
| PC07 — cross-source: fatura ↔ pagamento correspondente no extrato não reconciliado → mesma saída contável 2× entre documentos (fatura + débito no extrato) | consistência | Médio | P2 | procede | procede-aberto | [[ADR-350]] `Proposto` · PR1 measure-only #1087 (`82c04f0f`); enforce em [[A42.l11]] |

...
| RV8-09 — `record_review_reasons` tem call-site único dentro do ramo de pausa: stage WARN-first entrega razão no artefato e ela **nunca** chega à tabela. Exatamente os stages projetados para não pausar perdem 100% do diagnóstico | saúde-execução | Crítico | P0 | procede (novo) | procede-aberto | mover o sink para o caminho de saída de todo stage; teste que iguala razões do artefato às da tabela |

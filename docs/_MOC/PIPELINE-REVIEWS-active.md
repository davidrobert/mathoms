...
| PV9-13 — `folga_mensal` remove 100% dos gastos pontuais e a prescrição de teto **ancora nela**; duas sobras publicadas na mesma janela divergem em ~19 pp e a maior é a que prescreve | consistência | Alto | P1 | procede (novo) | **procede-fechado** ([[A40.l94]] · #1828 `05561dc0` · [[ADR-422]]) | invariante proposto: `\|folga_mensal − taxa_poupança × receita recorrente\| ≤ ε` — falha hoje |

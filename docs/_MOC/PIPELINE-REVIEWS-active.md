...
| PV9-16 — `if_meta` é composta pela fórmula **bruta** e consumida nos slots **líquidos**: os três campos publicados fecham a identidade bruta ao centavo, mas o gap e o progresso são as fórmulas líquidas | correção | Alto | P0 | procede (novo) | procede-aberto | inspecionar se a meta é declarada pelo dono ou derivada; o progresso carrega o maior peso do score · **dona [[A40.l91]]** |

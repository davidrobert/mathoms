...
Billing próprio (Stripe) está adiado para pós-launch. Ver [ROADMAP.md](ROADMAP.md).
...
Métricas de engenharia (coverage, CI gates, etc.) estão em [ROADMAP.md](ROADMAP.md).

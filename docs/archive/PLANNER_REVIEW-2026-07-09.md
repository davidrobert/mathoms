...
- [ADR-076 — Design system + codegen report_layout](../../adr/076-design-tokens-unificados-site-relatorio.md)
- [ADR-093 — Stage identifiers descritivos](../../adr/093-rename-completo-de-identificadores-de-stage.md)
- [ADR-128 — E7-review LLM lê/escreve via ArtifactStore](../../adr/128-e7-review-llm-leescreve-via-artifactstore.md) (a ser superseded)
- [ADR-136 — Decisions aggregate event-sourced](../../adr/136-decision-aggregate-event-sourced-com-supersede.md)
- [ADR-143 — Methodology as code](../../adr/143-docsmethodology-e-rules-as-code-sprint-a76.md)
- [ADR-144 — Section summaries LLM-driven com cache](../../adr/144-section-summaries-llm-driven-em-e5-com-cache.md)
- [ADR-153 — SuggestionCallout transição editorial em /acao](../../adr/153-suggestion-aggregate-direcao-e-onda-5-proposal.md)
- [ADR-187 — Imutabilidade de relatório pós-publicação](../../adr/187-relatorio-publicado-imutavel-mes-fechado.md)
- [ADR-188 — Schema evolution learning loop](../../adr/188-evolucao-schema-e-semantica-learning-loop-p3.md)

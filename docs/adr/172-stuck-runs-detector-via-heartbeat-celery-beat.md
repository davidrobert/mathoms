...
- Vocabulário aberto de `failure_reason` em [backend/app/services/pipeline/pipeline_failure_reasons.py](../../backend/app/services/pipeline/pipeline_failure_reasons.py) — começa com `heartbeat_timeout`, sem ENUM SQL.

...
**Referências:** [ADR-166 §Follow-ups item 2](#adr-166--schema-estável-cenarios_conjuge-no-payload-e5), [docs/reference/ARCHITECTURE.md §4.1 Domain glossary](../reference/ARCHITECTURE.md).

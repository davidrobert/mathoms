...
[[ADR-186]] (learning loop de categorização) introduz **re-categorização
...
| **D** | Não decidir agora; deixar [[ADR-186]] re-categorizar tudo retroativo sem barreira. | Quebra confiança (lição Mint/Copilot). Não-negociável pra produto premium. |

## Consequências

**Positivas:**

- Habilita [[ADR-186]] sem violar confiança do cliente.

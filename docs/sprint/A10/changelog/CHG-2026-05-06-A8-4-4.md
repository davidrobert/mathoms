...
summary: |
  docs(plan): A8.4 Cenários de Estresse — plano canônico + lane no BACKLOG (2026-05-06). - **docs(plan): A8.4 Cenários de Estresse — plano canônico + lane no BACKLOG (2026-05-06):** [docs/CENARIOS_ESTRESSE_PLAN.md](CENARIOS_ESTRESSE_PLAN.md) entregu
tags:
  - type/changelog-entry
  - sprint/a10
---

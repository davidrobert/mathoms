---
id: CHG-2026-04-24-F9-0
type: changelog-entry
date: "2026-04-24"
sprint: F9
lane: "[[F9.0]]"
adrs: ["[[ADR-070]]", "[[ADR-073]]", "[[ADR-076]]", "[[ADR-079]]", "[[ADR-080]]", "[[ADR-081]]", "[[ADR-083]]", "[[ADR-086]]", "[[ADR-090]]", "[[ADR-093]]", "[[ADR-097]]", "[[ADR-100]]", "[[ADR-101]]", "[[ADR-102]]", "[[ADR-103]]", "[[ADR-104]]", "[[ADR-105]]", "[[ADR-106]]", "[[ADR-108]]", "[[ADR-109]]", "[[ADR-110]]", "[[ADR-111]]", "[[ADR-112]]", "[[ADR-113]]", "[[ADR-114]]", "[[ADR-115]]", "[[ADR-116]]", "[[ADR-117]]", "[[ADR-118]]", "[[ADR-119]]", "[[ADR-120]]", "[[ADR-123]]", "[[ADR-124]]", "[[ADR-126]]", "[[ADR-127]]", "[[ADR-128]]", "[[ADR-129]]"]
prs: [8, 18, 51]
commits: ["b7e4c70", "5865d8b", "e6d4fdf", "152f205", "9f4c616", "94f693d", "4127abe", "5e72e72", "e634173", "a2123e2", "6f7c7a9", "10179dd", "1ae3475", "144eb07", "5c8e584", "289fa57", "6a09ff2", "84a0187", "bda1d17", "0f2811f", "91a2780", "c3af835", "8510cfa", "7a8a46c", "9c11749", "eb29688", "2a1261f", "c2fa932", "2663ec3", "0f4663a", "073db70", "44468ec", "ac6fa81", "dbc1195", "a2f8843", "9d5fbce", "c63497d", "78f9193", "5fc8cc4", "31f72cd", "f348654", "2804f65", "71dc379", "b17b83f", "ca9e93e", "b781ec7", "da133c0", "d319438", "eabdd04", "e52cea1", "35c7502", "d6cd3b3", "09bcc9c", "4f13b4a", "46a704c", "39c6711", "3b4c306", "7ee9703", "bacb218", "d4c4361", "cf8a4a5", "e35837e", "daddb8d", "93cef55", "c05e51b", "0c8fd11", "042c6ed", "41fa878", "b2e1f90", "eca59b0", "1c8ecfb", "8760d7e", "9cbcf2f", "16ef59c", "4958d9a", "ab240aa", "2c5c134", "9881135", "817f447", "52c252d", "1e4ab08"]
summary: "F9.0 audit ADR-093. - `dev/audit_stage_references.py` (ferramenta reutilizável) + `docs/archive/audits/f9_audit_20260424.md` (resumo): 3468 ocorrências de identificadores legados mapeadas"
tags:
  - type/changelog-entry
  - sprint/f9
---
...
- `dev/audit_stage_references.py` (ferramenta reutilizável) +
  `docs/archive/audits/f9_audit_20260424.md` (resumo): 3468 ocorrências de
...
- **A6c · Bridge + main(root_dir) legados removidos (2026-04-24):**
  ...
  - **A6c.4 · Docs:** `docs/reference/ARCHITECTURE.md` (diagrama, §17 bridge,
...
- **ADR-129 · Descontinuação completa do renderer HTML server-side
  ...
  **Consequência direta:** Report Premium Fases 11/12/13 canceladas;
  ...
  nova), BACKLOG.md (Fase 11 ❌ + nova lane), plan/REPORT_PREMIUM/_README.md
...
- **Report Premium UI — Fases 0-10 mergedas em `main` (2026-04-24 · ADR-117/
  ...
  [plan/REPORT_PREMIUM/_README.md](../../../plan/REPORT_PREMIUM/_README.md); gaps na Fase 0 em
  [REPORT_PREMIUM_GAPS.md](../../../plan/REPORT_PREMIUM/GAPS.md). **10 das 13 fases**
...
- **Default `MATHOMS_USE_DB_ARTIFACTS=true` (2026-04-23 · ADR-118):** flip do
  ...
  - `docs/reference/SETUP.md`, `docs/reference/ARCHITECTURE.md` (§17.3, §ArtifactStore),
    `docs/reference/STATELESS_AUDIT.md` (§6, conclusão) e `CLAUDE.md` (§Feature flag)
    atualizados para refletir default `True`.
  - `docs/reference/runbooks/cutover.md` mantido como **referência histórica e
...
- **A6g.3b — Decimal money: goal DTOs + `goal_service` math (slice 2 ✅) (2026-04-22):**
  ...
  - **OpenAPI snapshot:** Input/Output split agora aparece para DTOs
    ...
    intacto. Diff de +173/−21 linhas em `docs/reference/api/v1/openapi.json`.
...
- **A6g.2 — 1ª rodada pipeline style sweep (2026-04-21):**
  ...
  [`docs/archive/audits/code_style_audit_20260421.md`](../../../archive/audits/code_style_audit_20260421.md).
...
- **A6g.4b — 2ª rodada frontend style sweep (2026-04-22):**
  ...
  baseline T1-T5 de [`docs/archive/audits/code_style_audit_20260421.md`](../../../archive/audits/code_style_audit_20260421.md).
  Delta por categoria:
...
- **A6f.1 — Pipeline-as-Service HTTP boundary (2026-04-21 · ADR-112):**
  ...
  3. **Smoke + docker-compose + OpenAPI snapshot** —
     ...
     `docs/reference/api/v1/pipeline-service.openapi.json` + snapshot test
...
- **Plano-mestre A6 absorvido em fontes canônicas (2026-04-21):** O
  ...
  - **§7 Checklist de testes por fase** (92 linhas, 8 fases + métricas
    de sucesso) → `docs/reference/TESTING.md §Critérios de aceite por fase`.
  ...
  - **§16 Observabilidade de cutover** (5 métricas Prometheus + 4
    alertas + runbook T-24h/T-0/T+48h) → `docs/reference/runbooks/cutover.md`
    (nova §2.5 e §2.6; fix de 6 refs a `_scratch/compare_disk_vs_db.py`
    → `dev/compare_disk_vs_db.py` onde o script realmente vive).
  - **§1 Motivação P1-P11** → `docs/reference/ARCHITECTURE.md §17.0` em 3
...
- **Agent prompts — 3 novas lanes paralelas da Onda 2 (2026-04-21):**
  ...
  - **[track_a6f1_pipeline_service.md](../../A6/tracks/a6f1-pipeline-service.md)** — Pipeline-as-service (HTTP boundary, ADR-102). **Greenfield** em `pipeline-service/`; 3 slices (bootstrap FastAPI standalone → backend `PipelineServiceClient` adapter com fallback `InProcessPipelineClient` → smoke + OpenAPI + docker-compose). Mapeado ~2200 linhas core afetadas; 2-3 sessões estimadas.
  - **[track_a6g5_tests_sweep.md](../../A6/tracks/a6g5-tests-sweep.md)** — Tests sweep em `tests/`, `tests/unit/pipeline/`, `backend/tests/` (excluindo 16 goldens + fixtures A6g.2). Tier 1 `MagicMock` → fake nomeado (39 ofensores; top 2 em `test_events.py` + `test_pipeline_task.py`). Tier 2 nomes descritivos. Tier 3+4 opcionais.
  - **[track_a6e3_use_cases.md](../../A6/tracks/a6e3-use-cases.md)** — Application layer R15 (ADR-101) com **scope slicing** para evitar overlap com A6f.1: cobre apenas FamilyMember + Category + Goal (3 agregados sem imports de `PipelineRun`). ConfigBlob/Document/Task ficam para A6e.3b pós-A6f.1 merge.
...
- **A6f.6 — Stateless-rigoroso: audit + multi-worker integration test (2026-04-20) — ADR-111:**
  ...
  - **Novo: `docs/reference/STATELESS_AUDIT.md`** — 214 linhas, 10 seções auditando o
  ...
  - **Novo: ADR-111** — formaliza **R19 (stateless-rigoroso)**: zero estado
    ...
    idempotentes) catalogadas em `docs/reference/STATELESS_AUDIT.md`; proíbe
...
- **A6f.4 — DB Schema Reference auto-gerado + snapshot test (2026-04-20) — ADR-102 R20:**
  ...
  - **`docs/reference/DB_SCHEMA_REFERENCE.md`** — 1193 linhas, committed, atualizado
...
- **A6f.2 + A6f.5a — OpenAPI completo + Auth portability (2026-04-20) — ADR-109:**
  ...
  - **A6f.2 — OpenAPI completo**:
    ...
    - Snapshot committed em [`docs/reference/api/v1/openapi.json`](api/v1/openapi.json)
      (12856 linhas, sorted keys). README em [`docs/reference/api/v1/README.md`](api/v1/README.md).
...
- **Estratégia de subdomínios `mathoms.ai` (2026-04-20) — ADR-108:**
  ...
  - **Docs atualizados:** [ADR-108](../../../DECISIONS.md#adr-108--estratégia-de-subdomínios-mathomsai--cloudflare-dns),
    [ARCHITECTURE.md §18](../../../reference/ARCHITECTURE.md#18-domínios-e-urls-públicas-f7a),
    [ROADMAP.md F7A](../../../_MOC/_generated/ROADMAP.md#f7--produção--security--lgpd--operational-readiness-próxima),
...
- **Migração infra + domínio — Fases 1-5 completas + 6-8 foundation (2026-04-19):**
  Plano `_scratch/plano_migracao_artifacts_db.md`
  ...
  - **Docs** — ADRs 082-096 em [DECISIONS.md](../../../DECISIONS.md); [ARCHITECTURE.md](../../../reference/ARCHITECTURE.md)
    ...
    com status da migração; [SETUP.md](../../../reference/SETUP.md) §10 com instruções de cutover.
  ...
  - **Docs complementares (2026-04-19)** — ADRs 092-096 escritas; [TESTING.md](../../../reference/TESTING.md)
    com seção de testes de domínio e `InMemoryArtifactStore`; [runbooks/cutover.md](../../../archive/cutover-2026-05-14.md)
...
- **A6b.5 — Preparação para smoke test humano (2026-04-19):**
  ...
  - `docs/reference/SMOKE_TEST_HUMAN.md`: runbook com 46 checks em 8 categorias
...
- **Fase 8 Sessão A5e — Caminho B ativo para E5.N + E7 (2026-04-19):**
  **Fecha todos os stages determinísticos do pipeline no Caminho B.** E5.N
  ...
  - **A6b.5 + A6-human adicionados** como gate obrigatório antes de
    ...
    fixtures de documentos, runbook `docs/reference/SMOKE_TEST_HUMAN.md`,
...
- **Fase 6 Sessão A1 — pre-extraction E3 + adapter completo + goldens (2026-04-19):**
  ...
  - **Docs** — `docs/reference/TESTING.md` com seção goldens E3.
...
- **Pipeline paths (2026-04-17):** `MATHOMS_WORKSPACE_ROOT` obrigatória para `scripts.pipeline_common` (sem default para `data/` na raiz do git). `python -m pipeline.run_dev --root …` e a task Celery definem a variável; API/worker/pytest usam `setdefault` para a raiz do repo em dev. Docs: [SETUP.md §8](../../../reference/SETUP.md#8-pipeline-cli-sem-web), `scripts/__init__.py`.

- **Docs — estrutura de pastas (2026-04-17):** [CLAUDE.md](../../../../CLAUDE.md), [dev/README.md](../../../../dev/README.md), [ARCHITECTURE.md](../../../reference/ARCHITECTURE.md) §11 e [SETUP.md](../../../reference/SETUP.md) §8: árvore canónica sob `storage/<workspace_id>/`; pastas de dados na raiz do clone são opcionais (CLI com workspace = repo).

- **Dev — reset completo (2026-04-17):** CLI `python -m backend.app.scripts.reset_platform` (`--dry-run`, `--apply` com duas confirmações, `--skip-redis`). Docs: [SETUP.md](../../../reference/SETUP.md#reset-completo-da-plataforma-cli), [RUNBOOK.md](../../../reference/RUNBOOK.md#51-reset-intencional-dev--staging).
...
- **F7 / 7A.5:** `.env.example` na raiz (todas as `MATHOMS_*` documentadas + opcionais comentadas); `scripts/gen-secrets.sh` para gerar `MATHOMS_FERNET_KEY` / `MATHOMS_SECRET_KEY` (modo imprimir ou `--init-env` a partir do example); `docs/reference/SETUP.md` e README atualizados.
...
**Documentação:**
- Plano do **console interno** (operadores CEO/Ops/CS/Financeiro/LGPD): [INTERNAL_ADMIN_ROADMAP.md](../../../plan/INTERNAL_ADMIN/_README.md); sub-fase **F7F** no [BACKLOG.md](../../../BACKLOG.md); menções em [ROADMAP.md](../../../_MOC/_generated/ROADMAP.md) e [ARCHITECTURE.md](../../../reference/ARCHITECTURE.md).

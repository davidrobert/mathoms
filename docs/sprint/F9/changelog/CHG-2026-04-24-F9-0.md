...
summary: "F9.0 audit ADR-093. - `dev/audit_stage_references.py` (ferramenta reutilizável) + `docs/audits/f9_audit_20260424.md` (resumo): 3468 ocorrências de identificadores legados mapeadas"
tags:
  - type/changelog-entry
  - sprint/f9
---

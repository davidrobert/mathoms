...
| 5 | Dogfood real (G-f) | ✅ **Executado 2026-06-10 e validado pelo owner** — recompute isolado pré×pós A24 sobre o workspace real: 0 `value_delta` monetário fora do ruído de RNG do Monte Carlo (prova pré×pré) e timestamp; detalhe no [[MOC-sprint-a24]] §G-f. |

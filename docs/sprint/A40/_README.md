...
## Lanes (100 no disco · 100 nesta tabela — ver nota ao fim)
...
| [[A40.l99]] | Cinco ADRs em `Proposto` com lane fechada declaram decisão que não está em vigor | P2 | open | aberta 2026-08-30 no closeout da [[A40.l94]] · a proxy *"lane `shipped` ⇒ é só flipar a ADR"* foi verificada decisão a decisão contra o código e é **falsa em 5 de 6** · [[ADR-368]] passou e já flipou; [[ADR-362]] (D2 normativa violada no colofão e no `/health`), [[ADR-363]] (Resource do OTel sem `service.version`), [[ADR-385]] (D7 diz que não persiste e o script persiste), [[ADR-389]] (`compute_irrf_mensal` ainda hardcoded) e [[ADR-419]] (invariante não lê o artefato E5) **não** · **não é bookkeeping**: 3 das 5 têm cláusula normativa violada em superfície de cliente ou gate ausente |
| [[A40.l100]] | Cartão "NECESSÁRIO" publica a renda-alvo, não o aporte que o motor calcula | P0 | open | aberta 2026-08-30 do `RR7-01` da rodada unificada **U3** · o PMT correto já existe e aparece em 5 superfícies; o número do cartão é o único fora dessa cadeia · ⚠️ o critério de aceite proposto pela lente **não discrimina** — neste workspace o goal declarado e o PMT coincidem, então "batem" passa nas duas implementações; exige fixture em que difiram |
| [[A40.l101]] | Conserto da folga deixou `equivalente_meses_poupanca` auto-referente | P1 | open | aberta 2026-08-30 do `RR7-02` da **U3** · triagem **REGRESSÃO-DE-CONSERTO**: a [[A40.l94]]/[[ADR-422]] fechou o defeito principal e o campo irmão passou a ler a base nova, da qual o próprio numerador é 45,4% · cai a alegação de que a superlinearidade é o defeito — o defeito é o **polo** e o colapso |

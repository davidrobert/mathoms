...
| [[A40.l120]] | O parecer chama de renda fixa uma soma que inclui previdência, e o número com que ele deveria concordar não chega até ele | P1 | open | desmembrada 2026-09-01 da [[A40.l117]] (`RR9-08`/`PV13-08` da **U5**) · o discriminador **refuta o denominador**: `Caixa = 0`, e `90,25 + 4,14 = 94,39` é o carimbo ao centésimo — **o spread de 4,15 pp é a linha Previdência** · duas causas: `alocacao_alvo_deviation.py:18` dobra **toda** previdência em renda fixa sem declarar no rótulo, e `$.goals` só é projetado na seção que **foi evictada** neste run, então o modelo nunca recebeu o número · ordem obrigatória: projetar → corrigir o hint 357 → só então gatear (gate antes reprova o insolúvel, [[ADR-292]]) |

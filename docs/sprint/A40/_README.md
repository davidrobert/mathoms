...
> **→ zero**, `if_gap` **+27,3%**. **São SETE lanes na cláusula**, e o contador de 2 re-runs
> só inicia depois de as sete estarem terminais.
>
...
## Lanes (111 no disco · 111 nesta tabela — ver nota ao fim)

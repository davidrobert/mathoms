...
> bloqueante: o run saiu `completed` com 2 avisos de pausa. O sinal que existia e ninguém
> leu era a **contagem de `property_id` resolvidos caindo entre runs** — está no critério
> de aceite da [[A40.l113]]. Um gate que compara essa contagem entre dois runs sobre o
> mesmo corpus custa uma linha e pega a classe inteira.
>

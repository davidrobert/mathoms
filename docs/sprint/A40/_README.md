...
| [[A40.l68]] | Balanço de stage fan-out: documento que some não pode sair como sucesso | P1 | — | aberta 2026-08-17 na Onda 0 do [[PLAN-deterministic-authority]] · RV6-10 · `open` (liberada pelo dono 2026-08-18) · [[ADR-393]] `Decidido` (emendada 2026-08-19 e 2026-08-24) · **2a mergeado** (#1526); **2b** aberto em §Pendência datada · §Ataque 2026-08-24 (#1649) · **paralela desde o dia 0**, não disputa janela de rebaseline · [[A42.l4]] não amplia |

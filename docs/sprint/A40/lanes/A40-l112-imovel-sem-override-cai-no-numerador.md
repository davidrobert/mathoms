...
**Medido no golden (regime default, 2026-08-31):** com 100% de cat_2 sem override a
concentração sai **82,19%**; reclassificar **um** imóvel para `residencia_principal` o
tira do numerador **e** do denominador e leva o número a **0,00**. Um clique de UI move o
KPI de ponta a ponta, e nada na tela diz que ele era desse jeito.

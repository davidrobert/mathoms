...
> instrumentação (#711 + #713) e flip do default (#735) mergeados; resta só a janela
> de observação ≥1 sprint com uso real.
...
| [[A26.l4]] | `override-v2-on-instrumentacao` | B (habilitador) | in_progress (#711/#713/#735) | instrumentação ✅ + flip default ✅ (#735); resta só observação ≥1 sprint (`v1_fallback==0` com `v2_match>=1`) |
...
| [[A26.l10]] | `lgpd-export-cobertura` | A (sem gate) | shipped (#732) | — · fora do tema (LGPD Art.18); criada pela triagem do audit r4 (r2-new-2, decisão do owner 2026-07-02) |

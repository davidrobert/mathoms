...
| --- | --- | --- | --- | --- |
| F11.7a | **Catálogo de fórmulas** relevantes (FV anuidade, etc.): texto curto + referência ao código ou doc (`compute_if_derived`, E5). | P1 | 6h | ✅ [FORMULAS.md](../../../reference/FORMULAS.md) + `reportFormulas.ts` |

...
| F11.3c | **Checklist de QA** em [SMOKE_TEST.md](../../../reference/SMOKE_TEST.md) ou seção dedicada: “entrega impressa/PDF” (mínimo 5 itens). | P2 | 2h | ✅ §5.1 em SMOKE_TEST + itens Cmd+K / `?` em Auth |

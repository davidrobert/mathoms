...
- **Sprint A7 aberta — Config DB Cutover (CLI legacy removal) (2026-04-26) — 🚧 Onda 1 ✅ · Onda 2 destravada:**
  Plano canônico em [CONFIG_CUTOVER_PLAN.md](../../../archive/CONFIG_CUTOVER_PLAN-2026-04-27.md) — 11
  ...
  **Lanes:**
  - **A7.0** ConfigStore protocol + adapters — Onda 1 (BLOQUEANTE) · prompt: [track_a7_0_config_store.md](../tracks/a7-0-config-store.md).
  - **A7.1** Cutover `materialize_config` → `ConfigStore` — Onda 2 · [track_a7_1_cutover_materialize.md](../tracks/a7-1-cutover-materialize.md).
  - **A7.2a** Decision aggregate event-sourced + migrator + UI Plano de Ação + remove `decisions.md` — Onda 2 · [track_a7_2a_decision_aggregate.md](../tracks/a7-2a-decision-aggregate.md).
  - **A7.2b** `fiscal_parameters` + `market_rates` versionadas + remove `parametros_fiscais.json` + `taxas.json` — Onda 2 · [track_a7_2b_fiscal_market_tables.md](../tracks/a7-2b-fiscal-market-tables.md).
  - **A7.3** Catalog + Override resolver (categorization + institutions) + remove `categorization.json` + `institutions.json` — Onda 3 · [track_a7_3_catalog_override.md](../tracks/a7-3-catalog-override.md).
  - **A7.4** 4 `.md` metodologia → `docs/methodology/` — paralelo livre · [track_a7_4_methodology_docs.md](../tracks/a7-4-methodology-docs.md).
  - **A7.5** Cleanup final (`FileConfigStore`, `materialize_config`, paths proibidos) — Onda 4 (BLOQUEANTE) · [track_a7_5_cleanup.md](../tracks/a7-5-cleanup.md).

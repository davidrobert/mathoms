...
> **Status:** `current` (aberta 2026-07-07). 2 lanes paralelas. Origem: os 2
...
|---|---|---|---|
| [[A31.l1]] | Audit do console interno → tabela `internal_ops_audit` (7B.5, ADR-309) | P1 | open |
| [[A31.l2]] | Calibrar `MAX_SETTABLE_BUDGET_USD` US$ 1.000 → US$ 300 (emenda ADR-173) | P2 | open |

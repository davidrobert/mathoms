...
- `seed_if_goal_example.py` (paridade 3.000.000)
- `seed_tasks_example.py` (43 tasks, dep #19→#18, status done #2/#12)
- `seed_goals_workspace.py` (5 Goal types cobrindo 100% do goals.json)
...
- `docs/reference/tenancy.md` (300 linhas — guia do/don't + checklist PR + template test isolation)

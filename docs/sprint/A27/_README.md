...
| [[A27.l2]] | `cobertura-de-lineage-sem-gate` | ✅ shipped ([#1872](https://github.com/davidrobert/mathoms/pull/1872)) | aberta 2026-08-30 do `PV12-02` da **U4** — o gate é existência pura e o eval deriva `expected` do próprio registro. Remedido na execução: o `~87%` do enunciado contava prosa/metadado no denominador; a cobertura acionável é **5/14 = 35,7%** das raízes que publicam dinheiro — ⚠️ denominador da **fixture**, corrigido para **5/17 = 29,4%** pela [[A27.l3]] | [[ADR-281]] `Emendada 2026-08-30` |
| [[A27.l3]] | `cobertura-de-lineage-medida-contra-a-fixture` | ✅ shipped ([#1971](https://github.com/davidrobert/mathoms/pull/1971)) | aberta 2026-09-01 do `PV13-12` da **U5** — o gate da [[A27.l2]] tem controle positivo e **funciona**; o defeito era no **universo**, fixado sobre a fixture (**14**) enquanto a produção emite **17**. Medido na execução: o enunciado reproduz (14 · 18 · 36% · 28%) e a **composição não** — a 18ª (`narrativas`) entrava por `pontos_revisao`, uma contagem lida como R$. Universo vira **roster de origens** (fixture ∪ produção) e a cobertura publicada cai de **35,7% → 29,4%** | [[ADR-281]] `Emendada 2026-09-01` |

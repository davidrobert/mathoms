...
| [[A27.l2]] | `cobertura-de-lineage-sem-gate` | ✅ shipped ([#1872](https://github.com/davidrobert/mathoms/pull/1872)) | aberta 2026-08-30 do `PV12-02` da **U4** — o gate é existência pura e o eval deriva `expected` do próprio registro. Remedido na execução: o `~87%` do enunciado contava prosa/metadado no denominador; a cobertura acionável é **5/14 = 35,7%** das raízes que publicam dinheiro — ⚠️ denominador da **fixture**; corrigido pela [[A27.l3]] para **5/20 = 25,0%** | [[ADR-281]] `Emendada 2026-09-02b` |
| [[A27.l3]] | `cobertura-de-lineage-medida-contra-a-fixture` | ✅ shipped ([#1971](https://github.com/davidrobert/mathoms/pull/1971)) | aberta 2026-09-01 do `PV13-12` da **U5** — o gate da [[A27.l2]] tem controle positivo e **funciona**; o defeito era no **universo**, fixado sobre a fixture (**14**) enquanto a produção emite **17**. Medido na execução: reproduzem **14 · 18 · 35,7%**; **28% não** — a 18ª (`narrativas`) entrava por `pontos_revisao`, contagem lida como R$, e o real é 29,4%. Universo vira **roster de origens** (fixture ∪ produção). **Closeout 2026-09-02 achou 2 defeitos na própria entrega** (classificador cego a dinheiro-string; roster não-monotônico) e **fechou os dois no mesmo dia**, somando o contrato E5 como origem `schema`. Publicado: **5/20 = 25,0%** | [[ADR-281]] `Emendada 2026-09-02b` |

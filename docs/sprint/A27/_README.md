...
| [[A27.l2]] | `cobertura-de-lineage-sem-gate` | ✅ shipped ([#1872](https://github.com/davidrobert/mathoms/pull/1872)) | aberta 2026-08-30 do `PV12-02` da **U4** — o gate é existência pura e o eval deriva `expected` do próprio registro. Remedido na execução: o `~87%` do enunciado contava prosa/metadado no denominador; a cobertura acionável é **5/14 = 35,7%** das raízes que publicam dinheiro | [[ADR-281]] `Emendada 2026-08-30` |
| [[A27.l3]] | `cobertura-de-lineage-medida-contra-a-fixture` | open | aberta 2026-09-01 do `PV13-12` da **U5** — o gate da [[A27.l2]] tem controle positivo e **funciona**; o defeito é no **universo**: as raízes monetárias são fixadas sobre a fixture (**14**) e o payload real do run tem **18**, então 4 raízes ficam fora do denominador e a cobertura publicada sai **36%** contra **28%** reais, com viés **otimista que cresce sozinho** · é a distinção *sujeito da medição* que a [[A42.l14]] estabeleceu para conservação | [[ADR-281]] |

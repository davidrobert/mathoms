...
- **Labels:** "Independência Financeira" em headings; "Indep. Financeira" em label compacto. "IF" apenas em variáveis técnicas, no Apêndice A (glossário) e como fallback em viewport ≤320px. Regra completa em [docs/reference/COPY_GUIDELINES.md §3.1](../docs/reference/COPY_GUIDELINES.md).

...
- **Prazo**: Data ou período (Abr/2026, Mai/2026, 30/04/2026, T3/26, Antes EUA, 2027)
- **Prioridade**: S (Essencial) | R (Recomendada) | O (Opcional)
- **Status**: pendente | feito | cancelado
- **Ref**: Referência a decisão (D01, D02...) ou fonte (goals.json, life_plan, methodology)
...
|---|---|---|---|---|---|
| 1 | Quitar financiamento Ed. Gisele: C6 PJ R$117.430 + CDB-DI Itaú R$117.213 | Invest. | Abr/2026 | pendente | D01 |
| 3 | Solicitar resgate Safari 30 na Rico (~R$16.614, prazo D+60 para liquidação) | Invest. | Abr/2026 | pendente | — |
| 4 | Cancelar seguro de conta Santander (R$10/mês). Manter seguro de conta C6 (R$20/mês). | Orçamento | Abr/2026 | pendente | D08 |
| 5 | Configurar aporte R$20k/mês (dia 5): R$10k Cofrinhos Itaú + R$5k Tesouro IPCA+ + R$3k IVVB11 + R$2k Wise USD | Invest. | Abr/2026 | pendente | D02 |
...
| 19 | Iniciar aportes PGBL R$1.800/mês (economia IRPF R$5.940/ano). Depende de #18 (taxa PGBL). Quanto antes, melhor. | Tributário | Abr/2026 | pendente | — |
...
| 25 | Iniciar CGFNS + teste de inglês para Mariana (NCLEX). MET ou OET recomendados. Pode ser feito do Brasil — reduz gap de renda nos EUA em 3-9 meses. | Plan. EUA | T4/26 | pendente | goals.json |
...
| 29 | Configurar débito automático IPTU e condomínio de todos os 6 imóveis | Imóveis | Antes EUA | pendente | — |
...
| 35 | Avaliar venda Living Concept (yield 3,9% vs CDI 14,15%). Imóvel ficou vago 7 meses em 2025. | Imóveis | 2027 | pendente | D15 |
| 41 | Atualizar cadastro e pagar anuidade do Clube de Tiro Águia de Haia | Financeiro | Abr/2026 | pendente | — |
| 42 | Atualizar IPTU 2026 dos imóveis David (Calixto + Major Freire) na plataforma QuintoAndar | Imóveis | 30/04/2026 | pendente | — |
| 43 | Atualizar IPTU 2026 dos imóveis Mariana (Living Wish + Living Concept) na plataforma QuintoAndar | Imóveis | 30/04/2026 | pendente | — |
...
- **Prioridade abr/2026:** Tarefas #6 (AccountTech) e #11 (transf. auto C6) são pré-requisitos para as demais e devem ser feitas primeiro. Gov.br (#12) já concluído.
...
- **IPTU (#42-43):** Prazo rígido 30/04/2026 — QuintoAndar exige dados atualizados para repasse aos inquilinos.
- **Dependência:** #19 (PGBL aportes) depende de #18 (confirmar taxa PGBL). #13 (IRPF) depende de #6 (carnê-leão regularizado).
